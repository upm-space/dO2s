...
let _m2 = {mission:missionSuperficial,payload:payloadExample};
...
export default class MissionBuilderDO2sParser{
    ...
    getMission(){
        ...
        return {"waypoints":waypoints,"waypointLine":waypointLine,"flightData":flightData}
